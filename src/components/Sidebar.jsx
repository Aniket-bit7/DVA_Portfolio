export default function Sidebar(){
  return(
    <aside className="sidebar">
      <img
        src={`${import.meta.env.BASE_URL}Ani.jpeg`}
        alt="Profile"
        className="sidebar-avatar"
      />
      <h1 className="sidebar-name">Aniket Pathak</h1>
      <p className="sidebar-username">Aniket-bit7</p>
      <p className="sidebar-bio">
        Data Visualization Analyst skilled in Tableau and SQL, specializing in transforming complex data into clear, actionable dashboards and insights.
      </p>

      <button className="sidebar-follow-btn" onClick={() => window.open("https://github.com/Aniket-bit7", "_blank")}>Follow on GitHub</button>
      ...
      <div className="sidebar-info">
        ...
        <div className="sidebar-info-item">
          ...
          <a href="mailto:aniketpathak1073@gmail.com">aniketpathak1073@gmail.com</a>
        </div>
        <div className="sidebar-info-item">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="#8b949e">
            <path d="M7.775 3.275a.75.75 0 001.06 1.06l1.25-1.25a2 2 0 112.83 2.83l-2.5 2.5a2 2 0 01-2.83 0 .75.75 0 00-1.06 1.06 3.5 3.5 0 004.95 0l2.5-2.5a3.5 3.5 0 00-4.95-4.95l-1.25 1.25zm-4.69 9.64a2 2 0 010-2.83l2.5-2.5a2 2 0 012.83 0 .75.75 0 001.06-1.06 3.5 3.5 0 00-4.95 0l-2.5 2.5a3.5 3.5 0 004.95 4.95l1.25-1.25a.75.75 0 00-1.06-1.06l-1.25 1.25a2 2 0 01-2.83 0z"/>
          </svg>
          <a href="https://github.com/Aniket-bit7" target="_blank" rel="noreferrer">/github.com/Aniket-bit7</a>
        </div>
        <div className="sidebar-info-item">
          <svg viewBox="0 0 16 16" width="16" height="16" fill="#8b949e">
            <path d="M7.775 3.275a.75.75 0 001.06 1.06l1.25-1.25a2 2 0 112.83 2.83l-2.5 2.5a2 2 0 01-2.83 0 .75.75 0 00-1.06 1.06 3.5 3.5 0 004.95 0l2.5-2.5a3.5 3.5 0 00-4.95-4.95l-1.25 1.25zm-4.69 9.64a2 2 0 010-2.83l2.5-2.5a2 2 0 012.83 0 .75.75 0 001.06-1.06 3.5 3.5 0 00-4.95 0l-2.5 2.5a3.5 3.5 0 004.95 4.95l1.25-1.25a.75.75 0 00-1.06-1.06l-1.25 1.25a2 2 0 01-2.83 0z"/>
          </svg>
          <a href="https://www.linkedin.com/in/aniket-pathak-13822b311/" target="_blank" rel="noreferrer">linkedin.com/in/aniket-pathak-13822b311/</a>
        </div>
      </div>
